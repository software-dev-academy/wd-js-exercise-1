...
Your task is to convert the HTML file `preparation/part1/DOMToTree.html` to a tree similar to the one found 
...
found in `preparation/part2/DOMToTree.html` into an HTML-file.  
